...
public class jTPCC implements jTPCCConfig {
	...
	private long terminalsStarted = 0, transactionCount;

	private long sessionStartTimestamp, sessionNextTimestamp = 0, sessionNextKounter = 0;
	private long sessionEndTargetTime = -1, fastNewOrderCounter, recentTpmTotal = 0;
...
//		PropertyConfigurator.configure("log4j.xml");
	...
	private String getProp(Properties p, String pName) {
		...
		System.out.println("Term-00, " + pName + "=" + prop);
		return (prop);
	}
	...
	public jTPCC() {
		...
		System.out.println("Term-00, +-------------------------------------------------------------+");
		System.out.println("Term-00,      BenchmarkSQL v" + JTPCCVERSION);
		System.out.println("Term-00, +-------------------------------------------------------------+");
		System.out.println("Term-00,  (c) 2003, Raul Barbosa");
		System.out.println("Term-00,  (c) 2004-2014, Denis Lussier");
		System.out.println("Term-00, +-------------------------------------------------------------+");
		System.out.println("Term-00, ");
		...
		if (Integer.parseInt(iRunTxnsPerTerminal) == 0 && Integer.parseInt(iRunMins) != 0) {
			System.out.println("Term-00, runMins" + "=" + iRunMins);
		} else if (Integer.parseInt(iRunTxnsPerTerminal) != 0 && Integer.parseInt(iRunMins) == 0) {
			System.out.println("Term-00, runTxnsPerTerminal" + "=" + iRunTxnsPerTerminal);
		} else {
			...
			try {
				...
				try {
					...
					for (int i = 0; i < numTerminals; i++) {
						...
						System.out.println("esta es la conexion"+conn);
	...
	private void endReport() {
		...
		System.out.println("Term-00, ");
		System.out.println("Term-00, ");
		System.out.println("Term-00, Measured tpmC (NewOrders) = " + tpmC);
		System.out.println("Term-00, Measured tpmTOTAL = " + tpmTotal);
		System.out.println("Term-00, Session Start     = " + sessionStart);
		System.out.println("Term-00, Session End       = " + sessionEnd);
		System.out.println("Term-00, Transaction Count = " + (transactionCount - 1));

	}

	private void printMessage(String message) {
		System.out.println("Term-00, " + message);
	}
